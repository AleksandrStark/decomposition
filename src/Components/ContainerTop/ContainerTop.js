...
export default function ContainerTop(props) {
    ...
    const newsList = [
        ...
        {
            icon: "https://logos-download.com/wp-content/uploads/2021/01/Rossiyskaya_Gazeta_Logo.png",
            text: "«Турпомощь» прокомментировала гибель десятков россиян в Анталье",
            link: "#"
        },
        {
            icon: "https://www.avaclinic.ru/upload/iblock/d6e/komersant.jpg",
            text: "Суд закрыл дело Демпартии США прости России",
            link: "#"
        },
        {
            icon: "https://soft.softodrom.ru/screens/soft/86/23619/1985913784.png",
    ...
    const widjetContent = [{
        img: "https://s.a-5.ru/p/8e/28/8e28693fea5957d9.jpg",
